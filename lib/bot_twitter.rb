...
def the_20_most_recent_tweets_with_a_defined_search
get_the_20_most_recent_with_bonjour_monde = $client.search('#bonjour_monde', result_type: "recent").take(25)
return get_the_20_most_recent_with_bonjour_monde
end

puts the_20_most_recent_tweets_with_a_defined_search
...
$client.search("#bonjour_monde", result_type: "recent").take(25)

def tweet_bonjour_monde
    last_tweets_bonjour_monde = $client.search("#bonjour_monde", result_type: "recent").take(25)
    return last_tweets_bonjour_monde
end
  
def favorites (last_tweets_bonjour_monde)
    last_tweets_bonjour_monde.each do |like|
       $client.favorite(like)
    end
end
  
puts favorites(tweet_bonjour_monde)